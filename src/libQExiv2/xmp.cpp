...
double QExiv2::gpsCoordinates(const double deg, const double min, const double sec, const QChar &dir)
{
...
double QExiv2::gpsCoordinatesFromString(const QString &str, bool *ok)
{
     if (str.isEmpty()) {
         *ok = false;
         return 0.0;
